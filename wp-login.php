...
<html lang="fr-FR">
	...
	<title>Se connecter &lsaquo; portfolioUgo &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Aller sur portfolioUgo</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/portfolio\/Wordpress\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=6.0" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"75057b2e2a"};
</script>
